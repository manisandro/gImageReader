...
HOCRPdfExporter::HOCRPdfExporter(const HOCRDocument* hocrdocument, const HOCRPage* previewPage, DisplayerToolHOCR* displayerTool, QWidget* parent)
	...
	connect(ui.comboBoxBackend, qOverload<int>(&QComboBox::currentIndexChanged), this, &HOCRPdfExporter::backendChanged);
	connect(ui.toolButtonBackendHint, &QToolButton::clicked, this, &HOCRPdfExporter::toggleBackendHint);
	connect(ui.comboBoxOutputMode, qOverload<int>(&QComboBox::currentIndexChanged), this, &HOCRPdfExporter::updatePreview);
	connect(ui.comboBoxImageFormat, qOverload<int>(&QComboBox::currentIndexChanged), this, &HOCRPdfExporter::updatePreview);
	connect(ui.comboBoxImageFormat, qOverload<int>(&QComboBox::currentIndexChanged), this, &HOCRPdfExporter::imageFormatChanged);
	connect(ui.comboBoxDithering, qOverload<int>(&QComboBox::currentIndexChanged), this, &HOCRPdfExporter::updatePreview);
	connect(ui.comboBoxImageCompression, qOverload<int>(&QComboBox::currentIndexChanged), this, &HOCRPdfExporter::imageCompressionChanged);
	connect(ui.spinBoxCompressionQuality, qOverload<int>(&QSpinBox::valueChanged), this, &HOCRPdfExporter::updatePreview);
	connect(ui.checkBoxFontFamily, &QCheckBox::toggled, ui.comboBoxFontFamily, &QComboBox::setEnabled);
	connect(ui.checkBoxFontFamily, &QCheckBox::toggled, this, &HOCRPdfExporter::updatePreview);
	...
	connect(ui.comboBoxFontFamily, &QFontComboBox::currentFontChanged, this, &HOCRPdfExporter::updatePreview);
	connect(ui.comboBoxFallbackFontFamily, &QFontComboBox::currentFontChanged, this, &HOCRPdfExporter::updatePreview);
	connect(ui.checkBoxFontSize, &QCheckBox::toggled, ui.spinBoxFontSize, &QSpinBox::setEnabled);
	connect(ui.checkBoxFontSize, &QCheckBox::toggled, this, &HOCRPdfExporter::updatePreview);
	connect(ui.checkBoxFontSize, &QCheckBox::toggled, ui.labelFontScaling, &HOCRPdfExporter::setDisabled);
	connect(ui.checkBoxFontSize, &QCheckBox::toggled, ui.spinFontScaling, &HOCRPdfExporter::setDisabled);
	connect(ui.spinBoxFontSize, qOverload<int>(&QSpinBox::valueChanged), this, &HOCRPdfExporter::updatePreview);
	connect(ui.spinFontScaling, qOverload<int>(&QSpinBox::valueChanged), this, &HOCRPdfExporter::updatePreview);
	connect(ui.checkBoxUniformizeSpacing, &QCheckBox::toggled, this, &HOCRPdfExporter::updatePreview);
	connect(ui.spinBoxPreserve, qOverload<int>(&QSpinBox::valueChanged), this, &HOCRPdfExporter::updatePreview);
	...
	connect(ui.lineEditPasswordOpen, &QLineEdit::textChanged, this, &HOCRPdfExporter::updateValid);
	connect(ui.lineEditConfirmPasswordOpen, &QLineEdit::textChanged, this, &HOCRPdfExporter::updateValid);
	connect(ui.checkBoxPreview, &QCheckBox::toggled, this, &HOCRPdfExporter::updatePreview);
	connect(ui.comboBoxPaperSize, qOverload<int>(&QComboBox::currentIndexChanged), this, &HOCRPdfExporter::paperSizeChanged);
	connect(ui.comboBoxPaperSizeUnit, qOverload<int>(&QComboBox::currentIndexChanged), this, &HOCRPdfExporter::paperSizeChanged);
	connect(ui.toolButtonLandscape, &QToolButton::clicked, this, &HOCRPdfExporter::paperSizeChanged);
	connect(ui.lineEditPaperWidth, &QLineEdit::textChanged, this, &HOCRPdfExporter::updateValid);
	connect(ui.lineEditPaperHeight, &QLineEdit::textChanged, this, &HOCRPdfExporter::updateValid);
	connect(ui.pushButtonImport, &QPushButton::clicked, this, &HOCRPdfExporter::importMetadataFromSource);
