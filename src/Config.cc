...
const std::vector<Config::Lang> Config::LANGUAGES = {
	...
	{"ara", "ar", "\u0627\u0644\u0639\u0631\u0628\u064a\u0629"},
	{"bul", "bg", "\u0431\u044a\u043b\u0433\u0430\u0440\u0441\u043a\u0438 \u0435\u0437\u0438\u043a"},
	{"cat", "ca", "Catal\u00e0"},
	{"ces", "cs", "\u010cesky"},
	{"chi_sim", "zh", "\u7b80\u4f53\u5b57"},
	{"chi_tra", "zh", "\u7c21\u9ad4\u5b57"},
	{"dan-frak", "da", "Dansk (Frak)"},
	{"dan", "da", "Dansk"},
	{"deu-frak", "de", "Deutsch (Frak)"},
	{"deu-f", "de", "Deutsch (Frak)"},
	{"deu", "de", "Deutsch"},
	{"ell", "el", "\u0395\u03bb\u03bb\u03b7\u03bd\u03b9\u03ba\u03ac"},
	{"eng", "en", "English"},
	{"fin", "fi", "Suomi"},
	...
	{"kan", "kn", "\u0c95\u0ca8\u0ccd\u0ca8\u0ca1"},
	{"kor", "ko", "\ud55c\uad6d\ub9d0"},
	{"lav", "lv", "Latvie\u0161u Valoda"},
	{"lit", "lt", "Lietuvi\u0173 Kalba"},
	{"nld", "nl", "Nederlands"},
	{"nor", "no", "Norsk"},
	{"pol", "pl", "Polski"},
	{"por", "pt", "Portugu\u00eas"},
	{"ron", "ro", "Rom\u00e2n\u0103"},
	{"rus", "ru", "P\u0443\u0441\u0441\u043a\u0438\u0439 \u044f\u0437\u044b\u043a"},
	{"slk-frak", "sk", "Sloven\u010dina"},
	{"slk", "sk", "Sloven\u010dina"},
	{"slv", "sl", "Sloven\u0161\u010dina"},
	{"spa", "es", "Espa\u00f1ol"},
	{"srp", "sr", "\u0441\u0440\u043f\u0441\u043a\u0438 \u0458\u0435\u0437\u0438\u043a"},
	{"swe-frak", "sv", "Svenska (Frak)"},
	{"swe", "sv", "Svenska"},
	{"tgl", "tl", "Wikang Tagalog"},
	{"tur", "tr", "T\u00fcrk\u00e7e"},
	{"ukr", "uk", "Y\u043a\u0440\u0430\u0457\u043d\u0441\u044c\u043a\u0430"},
	{"vie", "vi", "Ti\u1ebfng Vi\u1ec7t"}
};
...
void Config::updateLanguagesMenu()
{
	...
	if(availLanguages.empty()){
		...
		Builder("tbmenu:main.recognize").as<Gtk::Widget>()->set_sensitive(false);
		return;
	}
	Builder("tbmenu:main.recognize").as<Gtk::Widget>()->set_sensitive(true);
