...
namespace Utils {
	...
	std::string save_image_dialog(const Glib::ustring& title, const std::string& suggestedFile, Gtk::Window* parent = 0);
	std::string save_dialog(const Glib::ustring &title, const std::string& suggestedFile, Glib::RefPtr<Gtk::FileFilter> filter, Gtk::Window *parent);
